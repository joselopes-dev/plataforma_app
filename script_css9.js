function onDragStart(event) {
  ...
  const columns = document.querySelectorAll(".column18");
  ...
  function checkSequence() {
      ...
      const items = document.querySelectorAll('.column18 .item');
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        const items = document.querySelectorAll('.column17 .item');
        items.forEach((item, index) => {
