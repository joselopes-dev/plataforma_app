function onDragStart(event) {
  ...
  const columns = document.querySelectorAll(".column12");
  ...
  function checkSequence() {
      ...
      const items = document.querySelectorAll('.column12 .item');
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        const items = document.querySelectorAll('.column11 .item');
        items.forEach((item, index) => {
