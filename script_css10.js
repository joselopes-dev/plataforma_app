function onDragStart(event) {
  ...
  const columns = document.querySelectorAll(".column20");
  ...
  function checkSequence() {
      ...
      const items = document.querySelectorAll('.column20 .item');
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        const items = document.querySelectorAll('.column19 .item');
        items.forEach((item, index) => {
