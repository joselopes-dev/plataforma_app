function onDragStart(event) {
  ...
  const columns = document.querySelectorAll(".column16");
  ...
  function checkSequence() {
      ...
      const items = document.querySelectorAll('.column16 .item');
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        const items = document.querySelectorAll('.column15 .item');
        items.forEach((item, index) => {
