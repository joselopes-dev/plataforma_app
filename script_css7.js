function onDragStart(event) {
  ...
  const columns = document.querySelectorAll(".column14");
  ...
  function checkSequence() {
      ...
      const items = document.querySelectorAll('.column14 .item');
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        const items = document.querySelectorAll('.column13 .item');
        items.forEach((item, index) => {
